...
const personObj = { name: 'Asilbek', age: 20 };
const myMap = new Map(Object.entries(personObj));
...
const oldArray = ['Ali', 'Vali', 'Soli', 'Ali', 'Gani', 'Vali'];
const cleanArray = [...new Set(oldArray)];

console.log(cleanArray);

const lotereyaSonlari = [10, 25, 10, 99, 25, 30];
const unikalSonlar = [...new Set(lotereyaSonlari)];

console.log(unikalSonlar);